...
/**
 * This class will connect to h2 sources and fetch the metadata from h2 source and inserts the same into staging tables.
 *
 * @author modakanalytics
 * @version 1.0
 */
public class FetchH2Stats extends MetadataFetcher {
    ...
    private  final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger("Fetchh2Stats");

    static boolean isDriverLoaded = false;

    @Override
    /**
     * this method will connect to h2 database with provided configurations
     */
    public void run() {
    ...
    public void init(ConnectAttributes connectAttributes, HashMap<String, String> koshAttributes,
        ...
        try {
            ...
            String hostname = connectAttributes.get("hostname");
